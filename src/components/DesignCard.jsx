  ...
  return (
    ...
    >
      <div className="relative overflow-hidden aspect-[4/5]">
        ...
        {/* dark gradient — strongest at the bottom, fading toward the top */}
        <div className="absolute inset-0 bg-gradient-to-t from-black/85 via-black/25 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
