          ...
          <div className="flex items-center gap-2.5 md:gap-3.5">
            ...
            {user ? (
              ...
              <div className="hidden sm:flex items-center gap-2.5">
                <Link
                  to="/login"
                  className="px-4 py-2 rounded-full text-sm font-medium text-primary border border-primary/25 transition-all duration-200 hover:bg-primary hover:text-bg hover:shadow-soft"
                >
                  Login
                </Link>
                <Link
                  to="/signup"
                  className="px-4 py-2 rounded-full text-sm font-semibold text-primary bg-highlight transition-all duration-200 hover:bg-accent hover:text-white hover:shadow-soft"
                >
                  Sign up
                </Link>
              </div>
