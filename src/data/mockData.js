...
export const products = [
  { id: "p1", name: "Hand-embroidered Bridal Lehenga", price: 8999, mrp: 12999, category: "Wedding", image: img("shop1", 700, 900), rating: 4.8, bestseller: true, recent: false },
  { id: "p2", name: "Maggam Work Blouse Piece", price: 2899, mrp: 3599, category: "Sarees", image: img("shop2", 700, 900), rating: 4.6, bestseller: false, recent: true },
  { id: "p3", name: "Kanjeevaram Silk Saree", price: 6999, mrp: 9999, category: "Sarees", image: img("shop3", 700, 950), rating: 4.9, bestseller: true, recent: false },
  { id: "p4", name: "Floral A-line Dress", price: 1499, mrp: 1999, category: "Dresses", image: img("shop4", 700, 900), rating: 4.4, bestseller: false, recent: true },
  { id: "p5", name: "Chikankari Anarkali Dress", price: 1899, mrp: 2499, category: "Dresses", image: img("shop5", 700, 900), rating: 4.7, bestseller: true, recent: false },
  { id: "p6", name: "Satin Nightie Set", price: 799, mrp: 1099, category: "Nighties", image: img("shop6", 700, 950), rating: 4.3, bestseller: false, recent: true },
  { id: "p7", name: "Reception Gown", price: 9999, mrp: 13999, category: "Wedding", image: img("shop7", 700, 980), rating: 4.9, bestseller: true, recent: false },
  { id: "p8", name: "Cotton Nightie Set", price: 599, mrp: 799, category: "Nighties", image: img("shop8", 700, 900), rating: 4.2, bestseller: false, recent: false },
  { id: "p9", name: "Sangeet Sharara Set", price: 6799, mrp: 8999, category: "Wedding", image: img("shop9", 700, 970), rating: 4.8, bestseller: false, recent: true },
  { id: "p10", name: "Georgette Saree with Blouse", price: 3199, mrp: 3999, category: "Sarees", image: img("shop10", 700, 920), rating: 4.5, bestseller: false, recent: false },
  { id: "p11", name: "Party Wear Bodycon Dress", price: 2199, mrp: 2799, category: "Dresses", image: img("shop11", 700, 950), rating: 4.6, bestseller: false, recent: true },
  { id: "p12", name: "Bridal Silk Saree", price: 12999, mrp: 17999, category: "Wedding", image: img("shop12", 700, 900), rating: 4.9, bestseller: true, recent: false },
];
...
export const contactInfo = {
  ...
  mapsUrl: "https://maps.app.goo.gl/tv5KjFJz2scosVhX8",
