...
export default function Shop() {
  ...
  const filtered = useMemo(() => {
    ...
    return list;
  }, [categoryFilters, priceFilters, discountFilter, ratingFilter, bestsellerOnly, recentOnly, sort]);
    ...
    <div className="max-w-7xl mx-auto px-5 md:px-8 py-16 md:py-24">
      ...
      <div className="grid lg:grid-cols-[240px_1fr] gap-10">
        ...
        <aside className={`${showFilters ? "block" : "hidden"} lg:block`}>
          <div className="bg-white rounded-2xl shadow-card p-5 lg:sticky lg:top-24 flex flex-col gap-6">
            <div>
        ...
        {!loading && filtered.length === 0 && (
          <p className="text-center text-ink/50 py-16 lg:col-start-2">No products match these filters yet.</p>
        )}
      </div>
    </div>
  );
