    ...
    <div className="max-w-6xl mx-auto px-5 md:px-8 py-16 md:py-24">
      ...
      <div className="grid lg:grid-cols-2 gap-12">
        <div className="flex flex-col gap-4">
          ...
          <a href={contactInfo.mapsUrl} target="_blank" rel="noreferrer" className="flex items-center gap-4 bg-white rounded-2xl shadow-card p-5 hover:shadow-soft transition-shadow">
