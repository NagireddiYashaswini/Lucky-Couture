...
import { Heart, Star, ShoppingBag, Zap, Scissors, ChevronLeft } from "lucide-react";
      ...
      <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 mb-16">
        ...
        <div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 text-sm font-medium text-accent border border-accent/40 py-3 rounded-full hover:bg-accent/5 transition-colors"
          >
